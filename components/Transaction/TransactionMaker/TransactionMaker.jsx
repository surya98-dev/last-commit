                  ...
                  <div className="relative top-3">
                    <div className="flex justify-center ">
                      ...
                      <div className="sr-only">
                        current {el.itemName} quantity is{" "}
                        {quantity[el.itemName]}
                      </div>
                      <input
                    ...
                    <div className="flex justify-center text-sm italic pt-1 font-semibold">
                      {el.stockQuantity} <ArrowSmRightIcon className="w-4" />{" "}
                      {trx === "Stock In" &&
                        el.stockQuantity + quantity[el.itemName]}
                      {trx === "Stock Out" &&
                        el.stockQuantity - quantity[el.itemName]}
                      {trx === "Audit" && quantity[el.itemName]}
                    </div>
                  </div>
                </td>
              </tr>
